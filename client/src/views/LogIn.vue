            ...
            <div class="container">
                <div class="box">
                    ...
                    <form @submit.prevent="login">
                        <input type="text" id="username" v-model="input.username" class="input-field" placeholder="Enter your username" required><br><br>
                        <input type="password" id="password" v-model="input.password" class="input-field" placeholder="Enter your password" required><br><br>
      ...
      methods: {
        login() {
          ...
          if (this.input.username !== "" && this.input.password !== "") {
            ...
            // You can add further authentication logic here, e.g., API calls
          } else {
